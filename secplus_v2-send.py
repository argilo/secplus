...
if __name__ == "__main__":
    ...
    if args.id:
        button_id = args.button_id or DEFAULT_BUTTON
        fixed_code =  (args.id & 0xffffffff) | (button_id << 32)
    else:
        fixed_code = args.fixed or DEFAULT_FIXED

    rolling_code = args.rolling or DEFAULT_ROLLING

    send_secplus_v2(fixed_dat=fixed_code, freq=args.freq, roll_dat=rolling_code)
